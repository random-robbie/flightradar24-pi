...
class LiveFlightPositionsLightApi:
    ...
    @validate_call
    def get_live_flight_positions_light(
        self,
        ...
        _param = self._get_live_flight_positions_light_serialize(
    ...
    @validate_call
    def get_live_flight_positions_light_with_http_info(
        self,
        accept_version: Annotated[StrictStr, Field(description="Specifies the FR24 API version. The currently available version is `v1`.")],
        bounds: Annotated[Optional[StrictStr], Field(description="Coordinates defining an area. Order: north, south, west, east (comma-separated float values). Up to 3 decimal points will be processed.")] = None,
        flights: Annotated[Optional[StrictStr], Field(description="Flight numbers (comma-separated values).")] = None,
    ...
    @validate_call
    def get_live_flight_positions_light_without_preload_content(
        self,
        accept_version: Annotated[StrictStr, Field(description="Specifies the FR24 API version. The currently available version is `v1`.")],
        bounds: Annotated[Optional[StrictStr], Field(description="Coordinates defining an area. Order: north, south, west, east (comma-separated float values). Up to 3 decimal points will be processed.")] = None,
        flights: Annotated[Optional[StrictStr], Field(description="Flight numbers (comma-separated values).")] = None,
    ...
    def _get_live_flight_positions_light_serialize(
        self,
        accept_version,
        bounds,
        flights,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/live/flight-positions/light',
