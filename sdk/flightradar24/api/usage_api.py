...
class UsageApi:
    ...
    def get_api_usage(
        ...
        _param = self._get_api_usage_serialize(
    ...
    @validate_call
    def get_api_usage_with_http_info(
        self,
        accept_version: Annotated[StrictStr, Field(description="Specifies the FR24 API version. The currently available version is `v1`.")],
        period: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetApiUsage200Response]:
        """Get info on API account usage
    ...
    @validate_call
    def get_api_usage_without_preload_content(
        self,
        accept_version: Annotated[StrictStr, Field(description="Specifies the FR24 API version. The currently available version is `v1`.")],
        period: Optional[StrictStr] = None,
        _request_timeout: Union[
