...
from flightradar24.api_client import ApiClient, RequestSerialized
from flightradar24.api_response import ApiResponse
from flightradar24.rest import RESTResponseType


class HistoricFlightPositionsLightApi:
    ...
    @validate_call
    def get_historic_flight_positions_light(
        self,
        ...
        :param timestamp: Unix timestamp representing the exact point in time for which you want to fetch flight positions. The timestamp must be within the past 3 years, subject to your subscription plan's limitations. Only one timestamp value is accepted; time ranges are not supported (required)
        :type timestamp: int
        ...
        _param = self._get_historic_flight_positions_light_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetLiveFlightPositionsLight200Response",
    ...
    @validate_call
    def get_historic_flight_positions_light_with_http_info(
        self,
        accept_version: Annotated[StrictStr, Field(description="Specifies the FR24 API version. The currently available version is `v1`.")],
        timestamp: Annotated[StrictInt, Field(description="Unix timestamp representing the exact point in time for which you want to fetch flight positions. The timestamp must be within the past 3 years, subject to your subscription plan's limitations. Only one timestamp value is accepted; time ranges are not supported")],
        bounds: Annotated[Optional[StrictStr], Field(description="Coordinates defining an area. Order: north, south, west, east (comma-separated float values). Up to 3 decimal points will be processed.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetLiveFlightPositionsLight200Response]:
        """Get historical flight positions with basic details
    ...
    @validate_call
    def get_historic_flight_positions_light_without_preload_content(
        self,
        accept_version: Annotated[StrictStr, Field(description="Specifies the FR24 API version. The currently available version is `v1`.")],
        timestamp: Annotated[StrictInt, Field(description="Unix timestamp representing the exact point in time for which you want to fetch flight positions. The timestamp must be within the past 3 years, subject to your subscription plan's limitations. Only one timestamp value is accepted; time ranges are not supported")],
        bounds: Annotated[Optional[StrictStr], Field(description="Coordinates defining an area. Order: north, south, west, east (comma-separated float values). Up to 3 decimal points will be processed.")] = None,
    ...
    def _get_historic_flight_positions_light_serialize(
        self,
        accept_version,
        timestamp,
        bounds,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/historic/flight-positions/light',
