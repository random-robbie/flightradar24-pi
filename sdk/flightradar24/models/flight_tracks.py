...
class FlightTracks(BaseModel):
    ...
    FlightTracks
    """ # noqa: E501
    fr24_id: Optional[StrictStr] = Field(default=None, description="Unique identifier assigned by Flightradar24 to the flight leg.")
    tracks: Optional[List[FlightTracksTracksInner]] = None
    __properties: ClassVar[List[str]] = ["fr24_id", "tracks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tracks": [FlightTracksTracksInner.from_dict(_item) for _item in obj["tracks"]] if obj.get("tracks") is not None else None
        })
        return _obj
